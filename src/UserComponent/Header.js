...
<header className="wow fadeInDown" data-offset-top={197} data-spy="affix">
    ...
    <nav className="main-nav nav navbar fixed-top">
          ...
          <div
            ...
            <li>
            <Link to="/" id={props.home}>Home</Link>
            </li>
            <li>
              <Link to="/About" id={props.About}>about</Link>
            </li>
            <li>
              <Link to="/Departments" id={props.Department}>Departments</Link>
            </li>
            <li className="dropdown">
                <Link to="#" id={props.Login || props.Signup} className="dropbtn" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pages <i className="fa hover-inn fa-angle-down" /></Link>
                <div className="dropdown-content">
                <Link to="/Login" id={props.Login}>Login</Link>
                <Link to="/Signup" id={props.Signup}>Sign Up</Link>
                
                </div>
            </li>
            <li>
              <Link to="/contact" id={props.contact}>contact</Link>
            </li>
          </ul>
          </div>
