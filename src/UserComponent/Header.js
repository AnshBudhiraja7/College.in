  ...
  <nav className="main-nav nav navbar fixed-top">
        ...
        <div
          ...
          <ul className="nav navbar-nav">
            ...
            <li>
              <a href="/About" id={props.About}>about</a>
            </li>
            <li>
              <a href="/Departments" id={props.Department}>Departments</a>
            </li>
            <li className="dropdown">
                <a href="#" id={props.Login || props.Signup} className="dropbtn" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pages <i className="fa hover-inn fa-angle-down" /></a>
                <div className="dropdown-content">
                <a href="/Login" id={props.Login}>Login</a>
                <a href="/Signup" id={props.Signup}>Sign Up</a>
                {/* <a href="#">Link 3</a> */}
                </div>
            </li>
            <li>
              <a href="/contact" id={props.contact}>contact</a>
            </li>
          </ul>
        </div>
